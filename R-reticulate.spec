...
Version  : 1.35.0
Release  : 78
URL      : https://cran.r-project.org/src/contrib/reticulate_1.35.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/reticulate_1.35.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706803960
