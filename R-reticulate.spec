...
Version  : 1.12
Release  : 28
URL      : https://cran.r-project.org/src/contrib/reticulate_1.12.tar.gz
Source0  : https://cran.r-project.org/src/contrib/reticulate_1.12.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1555081454
